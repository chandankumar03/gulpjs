...
function datepickr(id, userConfig) {
	...
	function initialise(userConfig) {
		...
		if(co==3 || co==4)
		{
			container.style.cssText = 'display: none; position: absolute; top: ' + (inputTop - 1600) + 'px; left: ' + inputLeft + 'px; z-index: 9999;';
		}else
		{
			container.style.cssText = 'display: none; position: absolute; top: ' + (inputTop - 310) + 'px; left: ' + inputLeft + 'px; z-index: 9999;';
		}
		co=co+1;
		//container.style.cssText = 'display: none; position: absolute; top: ' + (inputTop - element.offsetHeihgt) + 'px; left: ' + inputLeft + 'px; z-index: 9999;';
